...
fun FeedSectionTypeDTO.asEntity() = when (this) {
    ...
    FeedSectionTypeDTO.PHYSICAL_WELLBEING_RECOMMENDATIONS -> FeedSectionType.PHYSICAL_WELLBEING_RECOMMENDATIONS
    ...
    FeedSectionTypeDTO.PHYSICAL_WELLBEING_EXPLORE -> FeedSectionType.PHYSICAL_WELLBEING_EXPLORE
